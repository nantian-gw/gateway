...
var supportedResourceKinds = []resourceKindSpec{
	...
	},
	{
		descriptor: ResourceKindDescriptor{
			...
			Category:    "ai",
			Description: "Aether Gateway AI Service configuration",
			Namespaced:  true,
		},
	...
	},
	{
		descriptor: ResourceKindDescriptor{
			...
			APIVersion:  "gateway.nantian.dev/v1alpha1",
			Category:    "ai",
			Description: "Aether Gateway AI Token Policy configuration",
			Namespaced:  true,
		},
	...
	},
	{
		descriptor: ResourceKindDescriptor{
			...
			APIVersion:  "gateway.nantian.dev/v1alpha1",
			Category:    "wasm",
			Description: "Aether Gateway Wasm Plugin configuration",
			Namespaced:  true,
		},
