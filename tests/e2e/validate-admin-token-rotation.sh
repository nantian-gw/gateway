...
CONTROLPLANE_ADMIN_SECRET="${CONTROLPLANE_ADMIN_SECRET:-nantian-controlplane-admin-auth}"
DATAPLANE_ADMIN_SECRET="${DATAPLANE_ADMIN_SECRET:-nantian-dataplane-admin-auth}"
ADMIN_TOKEN_FILE_PATH="${ADMIN_TOKEN_FILE_PATH:-/etc/nantian-gw/admin-auth/token}"
