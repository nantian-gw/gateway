...
| Current Dependency Chain | `aether-core 0.8.0 -> prometheus 0.13.4 -> protobuf 2.28.0` |
| Upstream Blocker | The latest `aether` release on crates.io is still `0.8.0`; this release still uses `prometheus 0.13.x` via `aether-core`. |
